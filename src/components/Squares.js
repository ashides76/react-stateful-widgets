...
export default function Squares() {
  ...
  const [activeSquareId, setActiceSquareId] = useState(null);
  ...
  const markActive = id => {
    ...
    if (id === activeSquareId) {
      setActiceSquareId(null);
    } else {
      setActiceSquareId(id);
    }
    // id === activeSquareId ? setActiceSquareId(null) : setActiceSquareId(id)
  };
